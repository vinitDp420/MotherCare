...
// ... [truncated for ease of matching, we will select a smaller target content range below]
  en: {
    ...
    main: 'Main',
    dashboard: 'Dashboard',
    subheading: "Here's what's happening at MotherCare Maternity Hospital today.",
    report: 'Report',
  ...
  mr: {
    ...
    main: 'मुख्य',
    dashboard: 'डॅशबोर्ड',
    subheading: 'आज मदरकेअर हॉस्पिटलमध्ये काय घडत आहे ते पहा.',
    report: 'अहवाल',
  ...
  hi: {
    ...
    main: 'मुख्य',
    dashboard: 'डैशबोर्ड',
    subheading: 'आज मदरकेअर अस्पताल में क्या हो रहा है, यहां देखें।',
    report: 'रिपोर्ट',
    newPatient: 'नया मरीज',
